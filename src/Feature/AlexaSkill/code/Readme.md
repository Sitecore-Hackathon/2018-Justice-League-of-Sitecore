...
```
    cd "AlexConnect.Feature.AlexaSkill"
    dotnet restore
```

Execute unit tests
```
    cd "AlexConnect.Feature.AlexaSkill/test/AlexConnect.Feature.AlexaSkill.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "AlexConnect.Feature.AlexaSkill/src/AlexConnect.Feature.AlexaSkill"
